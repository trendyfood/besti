...
if (route(0) != 'admin' && route(0) != 'otp' && $settings['site_maintenance'] == 1 && $user["username"] != "revisionsmm"):
...
$menuslug = $menus["slug"];
    ...
    else
    {
        ...
        echo $twig->render($templateDir . '.twig', array(
            ...
            'ticketCount' => countRow(["table"=>"tickets","where"=>["client_id"=>$user['client_id'],"status"=>"answered"]]) ,
            'avarageTime' => $avarageTime,
